...
def classify_item(item: MonitoredItem, keywords: dict) -> Classification:
    ...
    combined_text = " ".join(part for part in [title, other_text] if part)
    ...
    if matched_terms and not (title_high or other_high) and _is_excluded_context(combined_text, keywords):
